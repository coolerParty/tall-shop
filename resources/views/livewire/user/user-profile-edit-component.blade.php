<div class="w-full pb-10 bg-orange-200">
    ...
    <div class="w-full bg-white">
        <nav class="container p-2 mx-auto">
            <ol class="flex list-reset">
                ...
                <li>
                    <a href="{{ route('user.profile') }}" class="text-blue-600 hover:text-blue-700">Profile</a>
                </li>
                <li><span class="mx-2 text-gray-500">/</span></li>
    ...
    <section class="container mx-auto" id="order">
        <h3 class="p-1 mt-10 text-3xl font-semibold text-center capitalize md:p-0">
            order now
        </h3>
        <h1 class="p-1 text-5xl font-bold tracking-tighter text-center text-orange-500 capitalize md:p-0">
            free and fast
        </h1>
        ...
        <form class="w-full mx-auto mt-10" wire:submit.prevent="update">
            <div
                ...
                <div
                    ...
                    @if ($newimage)
                    <img class="w-3/4 p-5 mx-auto rounded-full" src="{{ $newimage->temporaryUrl() }}" alt=""
                        width="100%" />
                    <x-link-danger type="button" wire:click="removeImage"
                        class="absolute block w-full cursor-pointer bottom-5">Remove Selected Image</x-link-danger>
                    @elseif($profile_photo_path)
                    <img class="w-3/4 p-5 mx-auto rounded-full" src="{{
                            asset('storage/assets/user/profile-photo/large')
                        }}/{{ $profile_photo_path }}" width="100%" alt="" />
                    @else
                    <img class="w-3/4 p-5 mx-auto rounded-full" src="{{
                            asset('storage/assets/user/profile-photo/large')
                        }}/default.png" width="100%" alt="" />
                    @endif
                </div>
