        ...
        @endif
                ...
                <div class="flex flex-col mt-1">
                    ...
                    <input type="email" name="email" id="email" placeholder="Email"
                        class="px-3 py-3 mt-1 font-semibold text-gray-800 bg-white border border-gray-400 w-100 dark:bg-gray-800 dark:border-gray-700 focus:border-indigo-500 focus:outline-none"
                        wire:model="email">
                </div>
