...
<div class="sticky top-0 z-40 w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800 border">
        <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
          ...
          <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
            <a class="px-4 py-2 mt-2 text-sm font-semibold text-white bg-orange-500 dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 text-white focus:text-gray-900 hover:bg-orange-600 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">Home</a>
