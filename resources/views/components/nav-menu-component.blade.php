...
<div class="sticky top-0 z-40 w-full text-gray-700 bg-white border dark-mode:text-gray-200 dark-mode:bg-gray-800">
    <div x-data="{ open: false }"
            ...
            <div class="flex">
                ...
                <div class="md:hidden">
                    <div class="flex text-right">
                        <a class="relative p-2 ml-2 text-sm font-semibold bg-gray-100 rounded-full md:mt-0 hover:bg-orange-500"
                            href="#">
                            <span class="absolute text-xs font-semibold text-gray-800 -top-1 -right-1">20</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-5 h-5 font-bold text-gray-800 hover:text-white">
        ...
        <nav :class="{'flex': open, 'hidden': !open}"
            ...
            <a class="px-4 py-2 mt-2 text-sm font-semibold text-white bg-orange-500 dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 focus:text-gray-900 hover:bg-orange-600 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                href="#">Home</a>
        ...
        <div class="hidden md:block">
            <div class="flex flex-grow pb-4 text-right md:pb-0 md:flex md:justify-end md:flex-row">
                <a class="relative p-2 mt-2 ml-2 text-sm font-semibold bg-gray-100 rounded-full md:mt-0 hover:bg-orange-500"
                    href="#">
                    <span class="absolute text-xs font-semibold text-gray-800 -top-1 -right-1">20</span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-5 h-5 font-bold text-gray-800 hover:text-white">
